...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		db.createBricks(new Bricks(187, "H�ndtering af brugsvand", "8A9B0F"));
		db.createBricks(new Bricks(188, "H�ndtering af spildevand", "8A9B0F"));
		db.createBricks(new Bricks(189, "H�ndtering af regnvand", "8A9B0F"));
